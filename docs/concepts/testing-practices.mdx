...
Solidus' [authorization system](../reference/authentication-and-authorization.mdx). This makes testing
...
prefer [customizing Solidus](../tutorials/your-first-store/customize-the-core.mdx) via the extension hooks or
...
You may also want to leverage some of the [built-in helpers](testing-practices.mdx#capybara-helpers)
...
subscribers](../reference/event-bus.mdx#testing-events) to see
