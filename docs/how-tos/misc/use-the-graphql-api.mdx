...
a [Solidus storefront](../../tutorials/your-first-store/customize-the-storefront.mdx). It will help you get familiar
with GraphQL on Solidus. You can use [our playground](#graphql-playground) as
...
our [payments section](/reference/payments-and-refunds.mdx), and don't forget to
