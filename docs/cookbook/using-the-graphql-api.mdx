...
a [Solidus storefront](../customization/creating-your-storefront.mdx). It will help you get familiar
with GraphQL on Solidus. You can use [our playground](graphql-api.mdx#solidus-graphql-playground) as
