...
Like the hero partial from earlier, this stylesheet was copied to the Rails app when SolidusStarterFrontend was installed on the app.

SolidusStarterFrontend stylesheets are written with [Sass][].
...
assets is straightforward. You're also provided an initial test suite to test drive your frontend
modifications.
